...
// Include certs for validating update source:
extern const uint8_t update_server_cert_pem_start[] asm("_binary_ca_cert_pem_start");
extern const uint8_t update_server_cert_pem_end[] asm("_binary_ca_cert_pem_end");
...
esp_err_t update_manager_update_from_web() {
    ...
    if (url == NULL) {
        ...
        esp_http_client_config_t config = {
            ...
            .cert_pem = (char*) update_server_cert_pem_start,
